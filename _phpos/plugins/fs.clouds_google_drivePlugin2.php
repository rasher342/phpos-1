...
*/
	...
	{		
		...
		$this->protocol_name = 'cloud_google_drive';		 	 
		...
		$this->client->setClientId('893916972523.apps.googleusercontent.com');
		$this->client->setClientSecret('S_VgFbW1Ycax8sWJOjcVznZd');
		$this->client->setRedirectUri($_SESSION['PHPOS_NETURL']);
