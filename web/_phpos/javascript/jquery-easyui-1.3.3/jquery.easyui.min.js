...
},plugins:["linkbutton","menu","menubutton","splitbutton","tree","layout","panel","datagrid","window","progressbar", "dialog", "calendar"],parse:function(_2){
var aa=[];
...
//sys
//alert(_22f.options.windowID+'system/api/libs/api_wintasks.controller.php?action=destroy&id='+_22f.options.windowID);
//$('#tasks').panel('refresh','system/api/libs/api_wintasks.controller.php?action=destroy&id='+_22f.options.windowID);
//$('#tasks').load('tasks.php?winTask_Action=winTask_destroy&winTask_ID='+_22f.options.windowID);
if(_22f.shadow){
_22f.shadow.hide();
}
if(_22f.mask){
